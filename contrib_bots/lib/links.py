...
class LinksHandler(object):
    '''
    This plugin facilitates creating a list of resources you want to save while using Zulip. It looks for messages starting with "@link" or "@resource". In this example, we send resources to private messages.
    '''
    ...
    def triage_message(self, message):
        ...
        if message['display_recipient'] == 'links':
            return False
        is_follow_up = (original_content.startswith('@link') or
